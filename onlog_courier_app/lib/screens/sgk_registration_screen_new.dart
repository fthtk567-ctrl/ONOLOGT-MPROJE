...
class SgkRegistrationScreenNew extends StatefulWidget {
  const SgkRegistrationScreenNew({super.key});

  @override
  State<SgkRegistrationScreenNew> createState() => _SgkRegistrationScreenNewState();
}

class _SgkRegistrationScreenNewState extends State<SgkRegistrationScreenNew> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      // emailRedirectTo: Email doğrulama sonrası yönlendirilecek sayfa
      final authResponse = await Supabase.instance.client.auth.signUp(
        email: _emailController.text.trim(),
        password: _passwordController.text,
        emailRedirectTo: 'io.supabase.onlog://login-callback/', // Deep link
        data: {
  ...
  String _getPageTitle() {
    switch (_currentPage) {
      case 0:
        return 'Adım 1/3: Hesap Bilgileri';
      case 1:
        return 'Adım 2/3: Kişisel Bilgiler';
      case 2:
        return 'Adım 3/3: Araç Bilgileri';
      default:
        return '';
    }
  }
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    'SGK\'lı kurye olarak şirket bünyesinde çalışacaksınız. '
                    'Vergi ve sigorta işlemleri şirket tarafından yapılacaktır.',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    'Başvurunuz şirket yöneticisi tarafından onaylandıktan sonra teslimat yapmaya başlayabilirsiniz.',
                    style: TextStyle(fontSize: 13, color: Colors.black87),
                  ),
                ),
              ],
